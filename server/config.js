...
export const DEFAULT_CONFIG = {
  ...
  theme: 'midnight',                       // midnight | daylight | focus | warm | nord | forest | sunset | mono | paper | cyan | cyan-dark | colorful
  widgetPalette: 'candy',                  // candy | sunset | ocean | pastel (colorful theme only — per-widget tile colors)
